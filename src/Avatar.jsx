...
const Avatar = () => { 
	...
	function downloadImage() { 
		Axios({ 
			method: "get", 
			url: `https://api.dicebear.com/8.x/${sprite}/svg?seed=${seed}/svg`, 
		...
		<div className="container"> 
			...
			<div className="home"> 
				<div className="btns"> 
					...
					<button onClick={() => { 
						handleSprite("adventurer") }}>Adven</button> 
					<button onClick={() => { 
						handleSprite("bottts") }}>Bots</button> 
					<button onClick={() => { 
						handleSprite("shapes") }}>Shapes</button> 
					<button onClick={() => { 
				...
				<div className="avatar"> 
					<img src= 
{`https://api.dicebear.com/8.x/${sprite}/svg?seed=${seed}/svg`} alt="Sprite" /> 
				</div> 
